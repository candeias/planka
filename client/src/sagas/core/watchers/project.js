...
export default function* projectWatchers() {
  yield all([
    ...
    takeEvery(
      ...
      ({ payload: { project } }) => handleProjectCreateService(project),
    ),
    takeEvery(
    ...
    takeEvery(
      ...
      ({ payload: { project } }) => handleProjectUpdateService(project),
    ),
    takeEvery(
    ...
    takeEvery(
      ...
      ({ payload: { project } }) => handleProjectDeleteService(project),
    ),
  ])
}
